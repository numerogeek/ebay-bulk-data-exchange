...
/**
 * This type defines the response container for all service operations. Contains error information associated with
 * the request.
 **/
class BaseServiceResponse extends EbatNsBulkDataExchange_ComplexType
{
