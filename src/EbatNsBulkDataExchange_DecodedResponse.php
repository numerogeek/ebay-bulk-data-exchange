...
class EbatNsBulkDataExchange_DecodedResponse
{
    /**
    * @var null|string
    */
    ...
    */
    ...
    /**
    * @var EbatNsBulkDataExchange_DecodedResponse[] e.g. multipart contents
    */
    protected $files = [];
    ...
    public function getObject()
    {
        ...
        return is_string($content) ? new EbatNsBulkDataExchange_ResponseError($content) : $content;
    }
