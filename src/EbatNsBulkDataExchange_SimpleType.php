 ...
 */
class EbatNsBulkDataExchange_SimpleType
{
    const TAG = '';
    const NAME = 'EbatNsBulkDataExchange_SimpleType';
    const XMLNS = 'http://www.w3.org/2001/XMLSchema';
    const REQUEST = null;

    protected static $_attributes = [
        /* pre-registered attributes */
        'EbatNsBulkDataExchange_SimpleType' => [],
        'EbatNsBulkDataExchange_EnumType' => [],
        'EbatNsBulkDataExchange_ComplexType' => []
    ];
