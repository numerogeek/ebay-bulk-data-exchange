...
class EbatNsBulkDataExchange_Response extends BaseServiceResponse
{
    /**
    ...
    */
    ...
    public static function parseError($xml, $parser)
    {
        ...
        $responseError = new EbatNsBulkDataExchange_ResponseError();
...
EbatNsBulkDataExchange_Response::_register();
