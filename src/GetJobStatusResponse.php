 ...
 * jobProfile
 * container, consisting of unique identifiers and job status and data for the job specified in the
 * jobId
 * field in the request. The response also includes standard output fields like
 * ack
 * ,
 * timestamp
 * ,
 * version
 * , and any errors/warnings that are generated by the request to retrieve the job.
 **/
class GetJobStatusResponse extends EbatNsBulkDataExchange_Response
{
    const TAG = 'GetJobStatusResponse';
    const NAME = 'GetJobStatusResponse';
...
GetJobStatusResponse::_register();
