 ...
 * ,
 * version
 * , and any errors/warnings that are generated by the request to start an upload job.
 **/
class StartUploadJobResponse extends EbatNsBulkDataExchange_Response
{
    const TAG = 'StartUploadJobResponse';
    const NAME = 'StartUploadJobResponse';
...
StartUploadJobResponse::_register();
