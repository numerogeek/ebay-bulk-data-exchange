...
abstract class EbatNsBulkDataExchange_AbstractBasicSession
{
    private $appModeUrls;
    ...
    public function curl()
    {
        ...
        return (new EbatNsBulkDataExchange_Curler($timeout))
            ->withApiUrl($apiUrl)
    ...
    public function getXmlCredentialHeaders()
    {
        ...
        $headers = [
            ...
            'X-EBAY-API-VERSION: 1.5.0',
            'X-EBAY-API-COMPATIBILITY-LEVEL: 1.5.0'
        ];
     ...
     *
     * @return EbatNsBulkDataExchange_Defines::APPMODE_* Value of the AppMode property
     */
     ...
     *
     * @param EbatNsBulkDataExchange_Defines::APPMODE_* $value
     */
    ...
    */
    ...
    {
        $entry = EbatNsBulkDataExchange_Defines::getGlobalIdEntry($value);
    ...
    {
        return $this->useStandardLogger
            ? new EbatNsBulkDataExchange_Logger(true, 'stdout', true, true)
            : null;
    }
